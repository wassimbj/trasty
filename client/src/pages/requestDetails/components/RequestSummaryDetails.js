...
export default function RequestAmountsDetails({
  ...
  return (
    <>
      <RequestAmountsDetailsWrapper>
        <RequestAmounts>
          <p>
            ...
            <ToolTip
              inline
              content="Includes the products price in case of quantity is more then 1"
            >
              <span>
                <Icon glyph="info" size={22} color="#b7b7b7" />
              </span>
            </ToolTip>
          </p>
        ...
        <RequestAmounts>
          <p>
            ...
            <ToolTip
              inline
              content="Approximate earning you will get when you deliver this product"
            >
              <span>
                <Icon glyph="info" size={22} color="#b7b7b7" />
              </span>
        ...
        <TotalAmount>
          <p>
            ...
            <ToolTip
              inline
              content="Total amount to be received when you deliver this order."
            >
              <span>
                <Icon glyph="info" size={22} color="#b7b7b7" />
              </span>
          ...
          <span>
            {parseFloat(
              parseFloat(reward) + parseFloat(productTotalPrice)
            ).toFixed(2)}{" "}
            TND
          </span>
        </TotalAmount>
      ...
      {
        isAddOfferModalOpen && !isLoggedIn.status && (
          <AuthModal onClose={() => setIsAddOfferModalOpen(false)} />
        ) 
      }
      {isLoggedIn.status && isAddOfferModalOpen && !isMyRequest && (
        <AddOfferModal
